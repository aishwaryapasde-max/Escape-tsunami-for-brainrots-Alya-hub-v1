-- [[ ALYA HUB V1 | ULTIMATE MASTERPIECE ]]
-- [[ CLEAN VERSION | ALL PRIVACY REMOVED ]]
...
AlyaBg.ImageTransparency = 0.7
AlyaBg.ZIndex = 0

-- // LOGIC // --
GetKeyBtn.MouseButton1Click:Connect(function()
    setclipboard(FirstStepLink)
